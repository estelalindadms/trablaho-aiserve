<template>
  <div>
    ...
    <div class="company-image">
      <img 
        src="https://senaiac.org.br/images/2019/12/16/senai1--web.jpg" 
        alt="SENAI"
      >
    </div>
    ...
    <div class="company-info-container d-flex align-items-center position-relative">
      <div class="d-flex align-items-center ps-4" style="width: 100%;">
        <img 
          src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQjgrWS-bcLf1OqWLxdM7IOPulZkCP9OhISbQ&s" 
          class="img-senai-logo me-4" 
          alt="Logo SENAI"
        >
        <h2 class="m-0">SENAI</h2>
      </div>
      <button 
            ...
            <form @submit.prevent="submitForm">
              <div class="mb-3">
                ...
                <select class="form-select" v-model="form.servico" required>
                  ...
                  <option value="curso">Cursos Profissionalizantes</option>
                  <option value="consultoria">Consultoria Técnica</option>
                  <option value="laboratorio">Uso de Laboratórios</option>
...
h2 {
  font-size: 40px;
  margin-left: 30px;
  color: #0066CC; /* Azul característico do SENAI */
}
...
.btn-submit {
  background-color: #0066CC; /* Azul SENAI */
  color: white;
  border: none;
  padding: 12px 20px;
  border-radius: 5px;
...
.btn-submit:hover {
  background-color: #004D99; /* Tom mais escuro de azul */
}

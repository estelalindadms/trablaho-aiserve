<template>
  <div>
    ...
    <div class="company-image">
      <img 
        src="https://i0.wp.com/www.downloadfonts.io/wp-content/uploads/2021/09/Coca-Cola-Logo-Font.jpg?fit=1000%2C566&ssl=1" 
        alt="Coca-Cola"
      >
    </div>
    ...
    <div class="company-info-container d-flex align-items-center position-relative">
      <div class="d-flex align-items-center ps-4" style="width: 100%;">
        <img 
          src="https://pbs.twimg.com/profile_images/1744786283531059200/lrggJynL_400x400.jpg" 
          class="img-coca-logo me-4" 
          alt="Logo Coca-Cola"
        >
        <h2 class="m-0">Coca-Cola</h2>
      </div>
      <button 
            ...
            <form @submit.prevent="submitForm">
              <div class="mb-3">
                ...
                <select class="form-select" v-model="form.servico" required>
                  ...
                  <option value="entrega">Entrega de Produtos</option>
                  <option value="evento">Serviço para Eventos</option>
...
h2 {
  font-size: 40px;
  margin-left: 30px;
  color: #F40009; /* Vermelho característico da Coca-Cola */
}
...
.btn-submit {
  background-color: #F40009; /* Vermelho Coca-Cola */
  color: white;
  border: none;
  padding: 12px 20px;
  border-radius: 5px;
...
.btn-submit:hover {
  background-color: #C00; /* Tom mais escuro de vermelho */
}

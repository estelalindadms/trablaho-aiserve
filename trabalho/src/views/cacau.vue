    ...
    <div class="company-info-container d-flex align-items-center position-relative">
      <div class="d-flex align-items-center ps-4" style="width: 100%;">
        <img 
          ...
          class="img-cacau-logo me-4" 
          alt="Logo Cacau Show"
        >
        <h2 class="m-0">Cacau Show</h2>
      </div>
      <button 
            ...
            <form @submit.prevent="submitForm">
              <div class="mb-3">
                ...
                <select class="form-select" v-model="form.servico" required>
                  ...
                  <option value="encomenda">Encomenda de Chocolates</option>
                  <option value="evento">Serviço para Eventos</option>
                  <option value="presente">Cestas de Presente</option>
                  <option value="franquia">Informações sobre Franquias</option>
...
h2 {
  font-size: 40px;
  margin-left: 30px;
  color: #5D2E1F; /* Cor marrom característica da Cacau Show */
}
...
.btn-submit {
  background-color: #5D2E1F; /* Marrom Cacau Show */
  color: white;
  border: none;
  padding: 12px 20px;
  border-radius: 5px;
...
.btn-submit:hover {
  background-color: #3D1E0F; /* Tom mais escuro de marrom */
}

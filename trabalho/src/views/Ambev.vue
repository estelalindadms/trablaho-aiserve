<template>
  <div>
    ...
    <div class="company-image">
      <img 
        src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQMLC6L5P0zGVQiiodAwnFUJJvNwel_S6tfVw&s" 
        alt="Ambev"
      >
    </div>
    ...
    <div class="company-info-container d-flex align-items-center position-relative">
      <div class="d-flex align-items-center ps-4" style="width: 100%;">
        <img 
          src="https://assets.hgbrasil.com/finance/companies/big/ambev-s-a.png" 
          class="img-ambev-logo me-4" 
          alt="Logo Ambev"
        >
        <h2 class="m-0">Ambev</h2>
      </div>
      <button 
